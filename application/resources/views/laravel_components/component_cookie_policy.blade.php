...
<div id="div-cookie-policy" class="text-muted hideme">
    ...
    <p>This cookie policy details how this site uses cookies in accordance with EU law. Consent to use these cookies
        ...
        site,
        and <strong>no</strong> persistent cookies will remain on your device after you terminate your browser session.
    </p>

    <p>Should you choose to proceed by using the &apos;OK&apos; button, cookies of the following type
        <strong>may</strong> be used on the
        site:</p>
    <ul>
    ...
    <ul>
        <li>This site does <strong>NOT</strong> use 3rd Party cookies for the purposes of tracking you, and no
            Personally Identifiable Information (PID) should be transmitted in conjunction with the analytics process.</li>
    </ul>

    <button id="btn-close-cookie-policy" class="hideit">close</button>
</div>